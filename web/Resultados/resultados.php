  						  ...
  						  <tbody>
     						 <tr style="color: #C0392B;font-size: 1.4em;font-family: 'Audiowide', cursive;margin: 0 0 10px 0;">
						        ...
						        <tr style="background:#DDDDDD">
						         ...
						         <td>
						      	<a href="whatsapp://send?text=Resultado : <?php echo NombreEquipo($datos['equipo1']).' vs '.NombreEquipo($datos['equipo2'])  ?>%20<?php echo $host . $url ?>" data-action="share/whatsapp/share">
