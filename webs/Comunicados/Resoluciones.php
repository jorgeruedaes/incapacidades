...
ContadorVisitas($ipvisitante,'resoluciones');
?>
				...
				<div class="col-md-12">
					...
					<div class="widget widget_categories">
						<div class="ec-fancy-title">
							<h2>RESOLUCIONES</h2> </div>
							<ul>
								<?php
								$vectores = ObtenerComunicados('resolucion');
								echo (empty($vectores)) ? '<div class="center"><cite>No hay resoluciones.</cite></div>' :'';
