...
}else if($bandera === "get_menu") {
    if (isset($_SESSION['padre']) and isset($_SESSION['hijo']) )
    {
        $resultado.='"mensaje":true';
        $resultado.=',"padre":'.$_SESSION['padre'].'';
        $resultado.=',"hijo":'.$_SESSION['hijo'].'';
    }
    else
    {
       $resultado.='"mensaje":false';   
   }
}else if($bandera === "delete_menu") {

    $resultado.='"mensaje":true';
    $_SESSION['padre']='';
    $_SESSION['hijo']='';
}else if($bandera === "set_menu") {

    $resultado.='"mensaje":true';
    $_SESSION['padre'] = $_POST['padre'];
    $_SESSION['hijo'] = $_POST['hijo'];
