...
$id_modulos ='75';
$idincapacidad = $_GET['id'];
$tipoincapacidad = $_GET['tipo'];
$corteincapacidad = $_GET['corte'];
        ...
        <section class="intro">
          <row>
            ...
            <div class="col-lg-12" id="caja-izq">
              <form>
                <div class="col-md-6" data-id="<?php echo $idincapacidad ?>" data-tipo="<?php echo $tipoincapacidad ?>" data-corte="<?php echo $corteincapacidad ?>" id="incapacidad-title">
                  <h3 class="grey-text">Editar incapacidad # <?php echo $idincapacidad ?></h3>
                </div>
                <div class="col-md-2 col-md-offset-4">
                  <label for="" style="padding-top: 1.7em">No. Incapacidad </label>
                  <div class="form-group">
                    <div class="form-line">
                      <input type="number" class="form-control incapacidad-number" placeholder="" disabled="disabled" />
                    </div>
                  </div>
                </div>
...
<!--  Js-principal -->
<script src="pages/incapacidades/js/editarincapacidad.js"></script>
