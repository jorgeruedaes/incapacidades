		...
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="body">
						<table  id="tabla-empresa" class="table table-bordered table-striped table-hover js-basic-example dataTable">
							<thead>
								<tr>
									<th>#</th>
									<th>Nombre</th>
							...
							<tbody>
								...
								foreach ($vector as  $value) {
									?>
									<tr>
										<th scope="row"><?php echo $value['id_empresas']; ?></th>
										...
										<td>
											<div class="btn-group btn-group-xs" role="group" aria-label="Small button group">
												...
												data-empresa="<?php echo $value['id_empresas']; ?>" 
...
<!-- JS ====================================================================================================================== -->
<!--  Js-principal -->
<script src="pages/maestros/js/empresa.js"></script>

<div class="modal fade" id="nuevoPerfil" data-perfil="" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			<h4 class="modal-title" id="defaultModalLabel">Nueva Empresa</h4>
			</div>
				...
				<div class="body">
					<form>
						...
						<div class="form-group">
							<div class="form-line">
								<input type="text" class="form-control n-nombre" placeholder="Nombre de la empresa" />
							</div>
						</div>
...
<div class="modal fade" id="defaultModal" data-empresa="" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="defaultModalLabel">Edición Empresas</h4>
			</div>
			<div class="modal-body">
				...
				<div class="body">
					<form>
						...
						<div class="form-group">
							<div class="form-line">
								<input type="text" class="form-control nombre" placeholder="Nombre de la empresa" />
							</div>
						</div>
						<label for="">Acronimo</label>
						<div class="form-group ">
